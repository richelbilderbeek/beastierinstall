...
test_that("create file", {
  ...
  beautier_cache_folder_name <- dirname(beautier::get_beautier_tempfilename())

  filename <- beautier::get_beautier_tempfilename()
...
test_that("create dir", {
  ...
  folder_name <- beautier::get_beautier_tempfilename()
